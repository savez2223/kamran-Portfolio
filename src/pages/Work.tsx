...
import { Briefcase, MapPin, Calendar, Award, GraduationCap, Rocket } from "lucide-react";
...
const Work = () => {
  ...
  const ongoingProjects = [
    {
      title: "EGMS_L3",
      description: "A new web platform to extract L3 data from the European Ground Motion Service (EGMS) website."
    },
    {
      title: "INLAND",
    ...
    {
      title: "ADCOM",
      description: "Development of an advanced computer vision algorithm for satellite image could removal."
    }
  ];
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-700">
                  Develop a high-performance hybrid soft computing model to conduct slope stability assessment of heavy-haul railway corridor.
                </span>
              </li>
              <li className="flex items-start">
                <Award className="text-green-600 mr-3 mt-1 flex-shrink-0" size={16} />
                <span className="text-gray-700">
                  Develop of high-performance hybrid soft computing models to sidestep of operation of laboratory test of California bearing ratio, Soil compression index, and Shear strength parameters.
                </span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="mb-6">
              <div className="flex items-center mb-4">
                ...
                <h2 className="text-2xl font-bold text-gray-900">Ongoing Work</h2>
              </div>

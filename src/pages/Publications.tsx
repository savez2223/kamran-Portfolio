...
const Publications = () => {
  const keyPublications = [
    ...
    },
    {
      ...
      authors: "Kamran S, Alzo'ubi, A. K., Palanivelu, S., Hamidian, P., GuhaRay, A., Kumar, G., & Asteris, P. G.",
    ...
    },
    {
      ...
      authors: "Kamran S, Kardani, N., Alzo'ubi, A. K., Samui, P., Gandomi, A. H., & Gokceoglu, C.",
    ...
    },
    {
      ...
      authors: "Kamran S, Samui, P., Ghosh, K., Gandomi, A. H., & Bhattacharyya, S.",
    ...
    },
    {
      ...
      authors: "Kamran S, Gokceoglu, C., Burman, A., Samui, P., & Asteris, P. G.",
    ...
    },
    {
      ...
      authors: "Kamran S Manna, P., Kumar, V., Burman, A., Žlender, B., & Samui, P.",
    ...
    },
    {
      ...
      authors: "Kamran S, Kardani, N., GuhaRay, A., Burman, A., Samui, P., & Zhang, Y.",
          ...
          <div className="space-y-6">
            {keyPublications.map((pub, index) => (
              <div key={index} className="border-l-4 border-blue-500 pl-6 py-2">
                ...
                <p className="text-blue-600 font-semibold mb-2">{pub.authors}</p>
              ...
              <div className="space-y-4">
                {publications.map((publication, index) => (
                  <div key={index} className="p-4 bg-gray-50 rounded-lg">
                    <p className="text-gray-800 text-sm leading-relaxed" dangerouslySetInnerHTML={{ __html: publication }}></p>
                  </div>
                ))}
              </div>
            </div>
